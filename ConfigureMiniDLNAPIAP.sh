...
echo -e ${WHITE}"    ${GREEN}friendly_name ${WHITE}to the predefined value of Circe"$(tput sgr0)
sed -i 's|#friendly_name=|friendly_name=Circe|g' /etc/minidlna.conf
